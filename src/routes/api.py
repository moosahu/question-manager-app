...
def get_backup_status():
    ...
    try:
        ...
        # المصدر الأساسي للحقيقة: قاعدة البيانات
        if backup_settings and backup_settings.auto_backup_enabled:
        ...
        if app_sched:
            try:
                ...
                # البحث عن مهمة المستخدم من APScheduler لتحديد next_backup
                user_job = None

...
def _remark_pdf_wrapper(sheets_html):
    ...
    return (
        ...
        '.question-row{display:flex;align-items:center;justify-content:center;padding:2px 0;gap:3px;}'
        '.question-num{width:19px;font-weight:bold;font-size:10px;text-align:center;}'
        '.answer-bubble{width:20px;height:20px;border:2px solid #000;border-radius:50%;display:inline-block;background:white;}'
        ...
        '.bubbles-labels-ar span{width:20px;text-align:center;display:inline-block;}'
        '.bubbles-labels-en{display:flex;gap:4px;font-size:9px;font-weight:bold;color:#666;margin-bottom:1px;}'
        '.bubbles-labels-en span{width:20px;text-align:center;display:inline-block;}'
        '.bubbles-row-only{display:flex;gap:4px;}'
        '.matching-bubble{width:20px;height:20px;border:2px solid #000;border-radius:50%;display:inline-block;background:white;}'
        ...
        '.matching-labels-ar span{width:20px;text-align:center;display:inline-block;}'
        '.matching-labels-en{display:flex;gap:4px;font-size:9px;font-weight:bold;color:#666;margin-bottom:1px;}'
        '.matching-labels-en span{width:20px;text-align:center;display:inline-block;}'

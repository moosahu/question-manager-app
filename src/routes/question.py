...
def _remark_pdf_wrapper(sheets_html):
    ...
    return (
        ...
        '.question-column{border-left:2px solid #000;padding:4px 5px;display:flex;flex-direction:column;overflow:hidden;height:100%;}'
        ...
        '.questions-grid>div{flex:1;overflow:hidden;display:flex;flex-direction:column;justify-content:space-between;}'
        '.questions-grid.matching-grid{flex-direction:column;}'
        '.questions-grid.matching-grid>div{flex:1;display:flex;flex-direction:column;justify-content:space-between;}'

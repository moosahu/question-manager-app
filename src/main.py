...
def create_app():
    ...
    # Configuration - Ensuring standard single quotes
    ...
    # Login view and message category - Ensuring standard single quotes
    ...
    # Basic route for index/home page - Ensuring standard single quotes
    @app.route('/')
    def index():

...
- ⚠️⚠️ كل عنصر بـactivity_materials هو كائن {{text, answer}} وليس نصاً مباشراً - text هو نص البطاقة الخام (بدون ترقيم أو تسمية "حصة"/"مجموعة" داخله)، وanswer إلزامي دائماً (لا تتركه فارغاً) يحتوي الإجابة/التصنيف/الحل الصحيح المحدد لنفس هذا text تحديداً

...
**تعليمات حاسمة**: ما سبق هو النص الكامل للكتاب بدقة 100%. اعتبره المصدر الوحيد للحقائق والبيانات، لكن **لا تنسخ جُمل الكتاب نفسها بالتحضير** — إليك الفرق بالضبط:
- ✅ انسخ كما هي (بدون أي تغيير): أرقام الأشكال (مثل: الشكل 4-4)، درجات الحرارة والأرقام، الصيغ الجزيئية، نص أسئلة الكتاب الداخلية إن استُخدمت
- ⚠️ لكن حقل "explanation" (الشرح) وحقل "objectives" (الأهداف) يجب أن تكتبهما **أنت بجملك الخاصة** بأسلوب معلّم يخاطب طلابه مباشرة وبلغة أبسط من لغة الكتاب — ممنوع نسخ فقرات أو جمل الكتاب نصاً واحداً بهذين الحقلين تحديداً، حتى لو كانت الحقائق نفسها مطابقة تماماً لما بالكتاب
...
{{
  ...
  "values_connection": {{
    ...
    "life": "ربط حقيقي بموقف من الحياة اليومية للطالب مرتبط فعلياً بمضمون هذا الدرس تحديداً — لا تتركه فارغاً أبداً"
  }},
  "presentation": {{
    "main_concepts": [
      {{
        ...
        "activity_materials": [
          {{
            "text": "نص البطاقة/السيناريو الجاهز للطباعة والقص للطالب - فقط لو نشاط الطلاب يتطلب توزيع بطاقات/أوراق مقصوصة على الطلاب (بطاقات سيناريوهات، بطاقات مطابقة، أوصاف صور تصرفات...)",
            "task": "جملة أمر مختصرة وواضحة تحدد بالضبط المطلوب من الطالب تجاه هذا السيناريو (مثل: 'صنّف هذا البحث: نظري أم تطبيقي؟ ووضّح السبب.' أو 'حدد الخطأ الأمني في هذا التصرف.') - تُطبع على البطاقة نفسها مع text، إلزامي دائماً حتى تكون البطاقة مكتفية بذاتها بدون رجوع الطالب للمعلم",
            "answer": "مفتاح الإجابة/التصنيف/الحل الصحيح لهذه البطاقة تحديداً - مختصر وواضح، يُطبع بنسخة المعلم فقط (منفصل عن البطاقة نفسها)"
          }}
        ],
        "examples": [
          {{
        ...
        "student_activity": "وصف تنفيذي واضح ومحدد لنشاط الطلاب المرتبط بهذا المفهوم: وش يسوّونه بالضبط خطوة بخطوة (فردي/مجموعات، كم دقيقة) - ليس عبارة عامة مثل 'نشاط تفاعلي'",
  ...
  "teaching_strategies": [
    {{
      ...
      "application": "مثال تطبيقي حقيقي ومحدد من محتوى هذا الدرس بالذات: وش يسوي المعلم بالضبط ووش يسوي الطلاب خطوة بخطوة لتطبيق هذه الاستراتيجية - ليس وصفاً عاماً",
      "duration_minutes": 10
    }}
  ],
  "evaluation": {{
  ...
  "individual_differences": {{
    "weak_support": [
      {{
        "strategy": "اسم أسلوب الدعم/السقالة التعليمية (مثل: تبسيط لغوي، مثال محسوس إضافي، تقسيم المهمة لخطوات أصغر، خريطة مفاهيم مبسطة)",
        "application": "وصف تنفيذي عميق (3-4 جمل على الأقل) لكيفية تطبيق هذا الأسلوب بالضبط على مفهوم هذه الحصة تحديداً - خطوة بخطوة، وش يسوي المعلم بالضبط مع هذا الطالب، ليس جملة عامة واحدة"
      }}
    ],
    "gifted_activities": [
      {{
        "strategy": "اسم النشاط الإثرائي (مثل: مسألة تحدٍّ، ربط بمفهوم متقدم، مشروع بحثي مصغّر)",
        "application": "وصف تنفيذي عميق (3-4 جمل على الأقل) لمهمة إثرائية حقيقية مرتبطة بمحتوى هذه الحصة تحديداً - ليس جملة عامة واحدة"
      }}
    ],
    "average_activities": ["أنشطة للمستوى المتوسط"],
    "learning_styles": {{
      "visual": "نشاط أو أداة بصرية محددة لمفهوم هذه الحصة تحديداً (رسم/مخطط/لون/فيديو) - ليس وصفاً عاماً",
      "auditory": "نشاط سمعي محدد لمفهوم هذه الحصة تحديداً (نقاش شفهي موجّه/تسجيل صوتي/شرح بصوت عالٍ لزميل)",
      "kinesthetic": "نشاط حركي أو حسي محدد لمفهوم هذه الحصة تحديداً (تجربة يدوية/نموذج ملموس/محاكاة حركية)"
    }}
  }},
  "student_reflection": {{
    "feynman_prompt": "تعليمة مباشرة للطالب: اشرح المفهوم الرئيسي لهذه الحصة بكلماتك البسيطة الخاصة، وكأنك تشرحه لأخوك الأصغر أو أحد أفراد أسرتك اللي ما يدرس كيمياء - بدون استخدام أي مصطلح علمي معقد بدون توضيحه",
    "gap_check": "سؤال يراجع فيه الطالب شرحه بنفسه بعد كتابته: وين حسّيت إنك تعثّرت أو احتجت ترجع للمصطلح العلمي الأصلي عشان تكمل الشرح؟ - يحدد فجوة الفهم الحقيقية عنده",
    "self_rating_options": ["فهمت الدرس تمام وأقدر أشرحه لغيري بثقة", "فهمت لكن محتاج مراجعة بسيطة لبعض النقاط", "محتاج مساعدة إضافية من المعلم قبل الحصة الجاية"]
  }},
  "homework": {{
    "main": ["الواجب الأساسي"],
...
- ⚠️⚠️ كل عنصر بـactivity_materials يجب يكون **محتوى/سيناريو مختلف تماماً** عن بقية العناصر (سيناريوهات متنوعة حقيقية، مو نفس النص/السيناريو مكرر حرفياً مع تغيير رقم المجموعة بس) - إلا لو طبيعة النشاط نفسها تتطلب صراحة نفس الورقة بالضبط لكل المجموعات (نادر، ونادراً ما يحصل). البطاقة نص خام للطالب بدون أي ترقيم أو تسمية "حصة"/"مجموعة" داخل النص نفسه (الترقيم يُضاف تلقائياً بالتصميم)
- ⚠️⚠️ كل عنصر بـactivity_materials هو كائن {{text, task, answer}} وليس نصاً مباشراً - text هو نص البطاقة الخام (بدون ترقيم أو تسمية "حصة"/"مجموعة" داخله)، task جملة أمر واضحة تحدد المطلوب من الطالب تجاه هذا السيناريو (تُطبع على البطاقة نفسها)، وanswer إلزامي دائماً (لا تتركه فارغاً) يحتوي الإجابة الصحيحة لنفس task/text تحديداً - الثلاثة إلزامية دائماً، لا تترك أي منها فارغاً
...
- ⚠️ رتّب main_concepts بتسلسل تربوي منطقي واضح: المفهوم الأساسي/الأبسط قبل المفاهيم المبنية عليه، والتعريف قبل التطبيق، والسبب قبل النتيجة — التزم بنفس محتوى ومصطلحات ومعطيات الكتاب المرفق أعلاه بدقة، لكن أعد ترتيب عرضها بترتيب تعليمي متسلسل ومفهوم لو ترتيب عرض الكتاب نفسه مبعثر أو غير مناسب لتسلسل حصة دراسية (لا تخترع محتوى غير موجود بالكتاب، فقط أعد التنظيم)
- ⚠️ اشرح كل مفهوم بنفس دقة ومحتوى الكتاب العلمي (نفس التعريفات والمعطيات والأرقام)، لكن **لا تنسخ نفس جمل وصياغة الكتاب حرفياً** — أعد الصياغة بأسلوب أبسط وأوضح وأسهل للطالب يشرح نفس الفكرة بلغة معلّم يخاطب طلابه مباشرة، مع الحفاظ الكامل على دقة المعلومة والأرقام والمصطلحات. ثم بعد الشرح أضف أمثلة إضافية غير موجودة بالكتاب حرفياً لتثبيت الفهم — لا تكتفِ بإعادة صياغة نفس أمثلة الكتاب فقط
- ⚠️ objectives يجب أن تكون أهدافاً سلوكية حقيقية بصيغة "أن + فعل إجرائي قابل للقياس + المحتوى" (مثل: أن يقارن الطالب بين... / أن يفسّر الطالب...) — لا تنسخ عناوين أو فقرات الكتاب كما هي كأهداف
- ⚠️ values_connection إلزامي بكامل حقوله الثلاثة (religious, national, life) في كل استجابة — لا يجوز ترك أي حقل منها فارغاً أو حذف القسم كاملاً بأي حال
- قدّم {examples} أمثلة محلولة بخطوات واضحة لكل مفهوم رئيسي (مثال واحد على الأقل مطابق للكتاب أو مبني عليه مباشرة، والباقي أمثلة إضافية جديدة بنفس مستوى الصعوبة)
...
- ⚠️ لا تتجاهل أي مثال أو تمرين أو معادلة موجودة في الصور - إذا وجدت أمثلة في الكتاب أضفها في الأقسام المناسبة
- ⚠️ المصطلحات في vocabulary يجب أن تكون كل المصطلحات الجديدة الموجودة فعلاً في الصفحات المرفقة
"""
        return prompt
...
{{
  ...
  "main_concepts": [
    {{
      ...
      "activity_materials": [
        {{
          "text": "نص البطاقة/السيناريو الجاهز للطباعة والقص للطالب - فقط لو النشاط يحتاج توزيع بطاقات/أوراق مقصوصة",
          "task": "جملة أمر مختصرة وواضحة تحدد بالضبط المطلوب من الطالب تجاه هذا السيناريو - تُطبع على البطاقة نفسها مع text، إلزامي دائماً",
          "answer": "مفتاح الإجابة/التصنيف/الحل الصحيح لهذه البطاقة تحديداً - مختصر وواضح، يُطبع بنسخة المعلم فقط"
        }}
      ],
      "examples": [
        {{
  ...
  "teaching_strategies": [
    {{
      "strategy": "اسم الاستراتيجية",
      "application": "مثال تطبيقي حقيقي ومحدد من محتوى هذه الحصة بالذات: وش يسوي المعلم بالضبط ووش يسوي الطلاب خطوة بخطوة لتطبيق هذه الاستراتيجية - ليس وصفاً عاماً",
      "duration_minutes": 10
    }}
  ],
  "evaluation": {{
...
- ⚠️ لا تتجاهل أي مثال أو تمرين أو جدول أو معادلة موجودة في الصور - اجعل المحتوى مستخرجاً من الكتاب فعلاً
- ⚠️ رتّب main_concepts بتسلسل تربوي منطقي واضح: المفهوم الأساسي/الأبسط قبل المفاهيم المبنية عليه، والتعريف قبل التطبيق، والسبب قبل النتيجة — التزم بنفس محتوى ومصطلحات ومعطيات الكتاب بدقة، لكن أعد ترتيب عرضها بترتيب تعليمي متسلسل ومفهوم لو ترتيب الكتاب نفسه غير مناسب لتسلسل حصة دراسية (لا تخترع محتوى غير موجود بالكتاب، فقط أعد التنظيم)
- ⚠️ اشرح كل مفهوم بنفس دقة ومحتوى الكتاب العلمي، ثم أضف بعد الشرح أمثلة إضافية غير موجودة بالكتاب حرفياً لتثبيت الفهم — لا تكتفِ بإعادة صياغة نفس أمثلة الكتاب فقط
- ⚠️ في homework.solved_examples: اختر أمثلة محلولة من الصفحات المرفقة أو مشابهة لها"""
...
{('## نص الكتاب لهذا الدرس (استخدمه لتحديد المفاهيم الفعلية الموجودة وتوزيعها):' + chr(10) + lesson_text_map.get(original_lesson.name, '')) if lesson_text_map.get(original_lesson.name) else ''}
...
- ⚠️⚠️ قبل التوزيع، اعمل جرداً كاملاً بذهنك لكل عنوان فرعي/خاصية/تصنيف مذكور صراحة بنص الكتاب أعلاه من أوله لآخره (بما فيها آخر صفحة) - **أي عنوان فرعي بالكتاب يجب يظهر بـcontent_scope حصة واحدة على الأقل، بدون استثناء ولو بدا ثانوياً أو مختصراً** (مثال: لو الكتاب يذكر تصنيف "الخواص الفيزيائية والكيميائية" كعنوان مستقل، يجب تخصيص جزء واضح له بإحدى الحصص، ما يكفي إنه يُذكر بس بأسئلة تقويم لاحقة بدون شرح فعلي)
...
- **أسئلة الفراغات**: غيّر ترتيب الجملة أو استخدم سياقاً مختلفاً لقياس نفس المعلومة — لا تكتب نوع السؤال في بدايته (لا تكتب "استنتاج عكسي" أو "تطبيق" أو أي تصنيف)
...
- **المسائل الحسابية**: نوّع بين ثلاثة أنواع:
  ...
  ⚠️ لا تكتب نوع المسألة في نص السؤال (لا تكتب "استنتاج عكسي" أو "مسألة عكسية" أو "متعددة الخطوات") — ابدأ السؤال مباشرة

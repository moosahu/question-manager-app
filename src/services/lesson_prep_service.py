...
- ⚠️ اشرح كل مفهوم بنفس دقة ومحتوى الكتاب العلمي (نفس التعريفات والمعطيات والأرقام)، ثم بعد الشرح أضف أمثلة إضافية غير موجودة بالكتاب حرفياً لتثبيت الفهم — لا تكتفِ بإعادة صياغة نفس أمثلة الكتاب فقط

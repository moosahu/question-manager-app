...
- **المسائل الحسابية**: نوّع بين نوعين فقط:
  1. مسألة متعددة الخطوات — تربط مفهومين من الدرس في سياق واحد
  2. مسألة فيها خطأ مقصود في الحل — اطلب من الطالب اكتشافه وتصحيحه
  ⚠️ لا تضع مسائل عكسية (reverse problems) بأي شكل

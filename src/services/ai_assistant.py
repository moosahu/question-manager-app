...
المطلوب: قم بإنشاء خريطة مفاهيم تفاعلية بصيغة JSON بالتنسيق التالي:

{{
  "center_node": {{
    "text": "المفهوم المركزي (مختصر - 3 كلمات كحد أقصى)",
    "color": "#FFD54F",
    "description": "وصف مختصر للمفهوم المركزي"
  }},
  "branches": [
    {{
      "text": "فرع رئيسي 1",
...
تعليمات مهمة:
1. العقدة المركزية يجب أن تكون مختصرة جداً (3 كلمات كحد أقصى)
2. عدد الفروع: من 3 إلى 6 فروع فقط
3. كل فرع يجب أن يكون مختصراً (4 كلمات كحد أقصى)
4. استخدم ألوان متنوعة من هذه القائمة:
   - #4A90E2 (أزرق)
   - #50C878 (أخضر)
   - #FF6B6B (أحمر)
   - #FFB347 (برتقالي)
   ...
   - #F39C12 (ذهبي)
   - #1ABC9C (فيروزي)
5. الوصف يجب أن يكون جملة واحدة فقط
6. الرد يجب أن يكون JSON فقط، بدون أي نص إضافي
7. استخدم اللغة العربية الفصحى
8. ركز على المفاهيم الأساسية والمهمة
9. المعادلات الكيميائية والقوانين (مهم جداً):
   - إذا كان الفرع يتعلق بمعادلة كيميائية أو قانون، أضفها في حقل "description"
   - استخدم Unicode للرموز: H₂O، CO₂، H₂SO₄، O₂، Na⁺، Cl⁻، →، ⇌، Δ، °
   - مثال وصف: "تتحد مولتان من الهيدروجين مع الأكسجين: 2H₂ + O₂ → 2H₂O"
   - مثال قانون: "قانون بويل: P₁V₁ = P₂V₂ عند ثبات درجة الحرارة"
   - مثال تأين: "HCl → H⁺ + Cl⁻ (تأين كامل في المحلول)"

...
class StudentAttendance(db.Model):
    ...
    period_number   = db.Column(db.Integer, nullable=False, default=1)  # رقم الحصة
    status          = db.Column(db.String(20), nullable=False, default='present')  # present/absent/late/sleeping

...
class Result(db.Model):
    """نموذج نتائج اختبارات الطلاب - نسخة متوافقة مع reports.py"""
    ...
    quiz_id = db.Column(db.Integer, nullable=True)  # ✅ إضافة quiz_id
    ...
    def __repr__(self):
        return f'<Result {self.id} - {self.quiz_name}: {self.score_percentage}%>'
